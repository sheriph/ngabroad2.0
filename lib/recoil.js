...
export const airlineFilterOffers_ = atom({
  key: "airlineFilterOffers_",
  default: [],
  dangerouslyAllowMutability: true,
  //  effects_UNSTABLE: [persistFxn("flightOffer_")],
});

export const stopsFilterOffers_ = atom({
  key: "stopsFilterOffers_",
  default: [],
  dangerouslyAllowMutability: true,
  //  effects_UNSTABLE: [persistFxn("flightOffer_")],
});

export const filteredOffers_ = atom({
  key: "filteredOffers_",
  default: [],
  dangerouslyAllowMutability: true,
  //  effects_UNSTABLE: [persistFxn("flightOffer_")],
