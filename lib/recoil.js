...
const { persistAtom: persistSelectCategory_ } = recoilPersist({
  key: "persistSelectCategory_",
});

export const selectCategory_ = atom({
  key: "selectCategory_",
  default: null,
  dangerouslyAllowMutability: true,
  effects_UNSTABLE: [persistSelectCategory_],
});

const { persistAtom: persistSelectCategoryString_ } = recoilPersist({
  key: "persistSelectCategoryString_",
});

export const selectCategoryString_ = atom({
  key: "selectCategoryString_",
  default: "",
  effects_UNSTABLE: [persistSelectCategoryString_],
});
